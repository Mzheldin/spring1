...
public class StudentsController {
    ...
    public String showAddForm(Student student, Principal principal, BindingResult theBindingResult) {
        if (theBindingResult.hasErrors()) return "add-student-form";
        student.setRegData(studentsService.getDate());
    ...
    public String addCourseToStudent(@PathVariable(value = "studentId") Long studentId, @PathVariable(value = "courseId") Long courseId) {
    ...
    public String removeCourseFromStudent(@PathVariable(value = "studentId") Long studentId, @PathVariable(value = "courseId") Long courseId) {
